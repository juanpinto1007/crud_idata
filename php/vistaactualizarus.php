...
<body>
    ...
    <div class="container">
       <div class="abs-center" id="centrar">
        <form action="?accion=actualizarusuario" method="post" id="formulario">

       <h3 id="tituloperso"> Actualizar Usuario</h3>
       <?php
            ...
            ?>
                    ...
                    <input type="number"class="form-control" placeholder="Identificación" name="identidad" reandoly value="<?php if(isset($identidad_id)){echo $identidad_id;} ?>">
